                                ...
                                {data?.map((row, i) => {
                                    return (
                                        ...
                                        >
                                            ...
                                            <Td width={2}>
                                                <Flex gap={2}>
                                                    {!!onEdit && <EditIcon _hover={{ color: brand, fontSize: 18 }} onClick={(e) => handleOnEdit(e, row)} cursor="pointer" />}
                                                    {!!onDelete && <>
                                                        {loadings?.delete === row.id
                                                            ? <Spinner size="sm" />
                                                            : <DeleteIcon _hover={{ color: brand, fontSize: 18 }} onClick={(e) => handleOnDelete(e, row)} cursor="pointer" />
                                                        }
                                                    </>}
                                                </Flex>
                                            </Td>
